...
#Parameters
# Installation Stand alone WinCollect agent for Endpoints 

$fd='https://Path_to_sharing_folder/wincollect-7.3.0-41.x64.exe' # Change sharing folder 
$fs=$env:windir+'\Temp\wincollect-7.3.0-41.x64.exe'
...
function Component ($x) {
    ...
    $EventRateTuningProfile='Default+(Endpoint)'
    $RemoteMachinePollInterval=3000
    $MinLogsToProcessPerPass=100
    $MaxLogsToProcessPerPass=150
